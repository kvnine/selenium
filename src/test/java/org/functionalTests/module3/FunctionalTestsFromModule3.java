package org.functionalTests.module3;
...
public class FunctionalTestsFromModule3 extends CommonLibrary{
	...
	public void Module3Test1() {
		...
		System.out.println("module3 test1");
	...
	@Test(priority = 2)
	public void Module3Test2() {
		System.out.println("module2 test2");
		// Verify login page title
		String loginPageTitle = objLogin.getLoginTitle();
		System.out.println(loginPageTitle);
		//Assert.assertTrue(loginPageTitle.toLowerCase().contains("guru99 bank"));
	...
	public void Module3Test3() {
		...
		System.out.println("module3 test3");
		// Verify login page title
		String loginPageTitle = objLogin.getLoginTitle();
		System.out.println(loginPageTitle);
		//Assert.assertTrue(loginPageTitle.toLowerCase().contains("guru99 bank"));
